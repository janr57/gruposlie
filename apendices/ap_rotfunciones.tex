...
\item Deberíamos rotar todos los puntos del espacio $\vvv{r} = (x,y,z)$, donde esté
  ...
  \begin{equation}\label{eq:cla-rotacion-aciva-funcion-coordenadasrotadas}
    \xtilde{r} = \mmm{R}^{-1}\,\vvv{r} = e^{-\theta\xhat{n}\cdot\mmm{G}}\vvv{r}
  \end{equation}
\end{subequations}
...
\item ¿Cómo podremos dar con una expresión matemática para la función rotada $\tilde{f}$?
  ...
  \begin{subequations}
    ...
    \begin{equation}\label{eq:cla-rotacion-aciva-funcion-coordenadasoriginales}
      \vvv{r}
      = \mmm{R}^{-1} \xtilde{r}
      = e^{\theta\xhat{n}\cdot\mmm{G}}\xtilde{r}
    \end{equation}
    ...
    \begin{equation}\label{eq:cla-rotacion-de-funcion}
      f(\vvv{r}) = f(\mmm{R}^{-1}\vvv{r}) = \tilde{f}(\xtilde{r})
    \end{equation}
  \end{subequations}
  ...
  $\tilde{f}(\xtilde{r})$, se le aplica la rotación inversa
  ...
  \begin{figure}[ht]
    ...
    \begin{tikzpicture}[%
      ...
      \node[above=5pt] at (OP'midway) {$\xtilde{r}$};
      ...
      \node[above] at (p'arrow) {$\tilde{f}(\xtilde{r})$};
    ...
    \caption{Para calcular el valor de la función rotada $\tilde{f}$ en el punto
      $\tilde{P}$, esto es, ($\tilde{f}(\xtilde{r}$), giramos el punto
...
\item Sustituya las coordenadas originales en la función original por sus equivalentes
  ...
  $\tilde{f}(\xtilde{r})=f(\mmm{R}^{-1}\xtilde{r})$
...
El punto rotado es $\xtilde{r} = (0,1,0)$
\[
  \vvv{r}(1,0,0)
  \longrightarrow
  \vvv{r}'(0,1,0)
...
\begin{figure}[ht]
  ...
  \begin{tikzpicture}[%
    ...
    (0,0,0) -- node[above left=0pt and -3pt] {\small $\xtilde{r}$}
    ...
    {\footnotesize $\tilde{f}(\xtilde{r}) = 2$};
...
\[
  ...
  \longrightarrow
  \xtilde{r}_0 = (\cos\theta\,x_0 - \sin\theta\,y_0,
...
\[
  \vvv{r}
  = \mmm{R}_z^{-1}(\theta)\,\tilde{r}
  = e^{\theta\mmm{G}_z} \,\tilde{r}
\]
\[
  \begin{pmatrix}
    x \\
