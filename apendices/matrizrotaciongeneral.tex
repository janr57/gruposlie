...
\label{apend:matrizrotaciongeneral}
...
Desarrollamos el producto escalar $\mmm{x}\cdot\xhat{n} = n_xx+n_yy+n_zz$ y sustituimos
...
Comparando términos, obtenemos la expresión general de la matriz de rotación en
el espacio euclídeo de tres dimensiones
\[
   \mmm{R}(\xhat{n}, \alpha)
   =
   \begin{pmatrix}
