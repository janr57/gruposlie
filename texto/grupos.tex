...
Uno de estos criterios se basa en el número de elementos que lo forman:
\begin{itemize}
\item \emph{grupos finitos}: cuando el número de elementos es finito
\item \emph{grupos infinitos}: cuando su cardinalidad es infinita.
\end{itemize}

%\newpage
Por otro lado, atendiendo a la numerabilidad, tendremos:
\begin{itemize}
\item \emph{Grupos numerables}:
  Cuando el número de elementos es finito o existe una biyección entre los elementos
  del grupo y el conjunto de enteros.
\item \emph{Grupos continuos}: En caso contrario.
\end{itemize}
