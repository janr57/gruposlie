...
lo indicamos en rojo. En este caso, debido a que la matriz es $2\times 2$, el menor
complementario es un determinante formado por un único elemento, representado en negrita
\begin{align*}
  A_{11}
  &= \text{cof}\,(B_{11})
    = (-1)^{1+1}\,\text{det}
