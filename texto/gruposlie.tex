...
Y teniendo en cuenta que el determinante de la matriz valía la unidad, ver
...
Las nuevas coordenadas se obtienen aplicando la matriz de rotación a las del sistema sin
girar
\[
  \vvv{x'} = \mmm{R} \vvv{x}
\]
...
\section{Grupos de Lie}\label{sec:gruposlie}
...
que su cuadrado es despreciable (si $\varepsilon$ es infinitesimal, entonces
...
La matriz de rotación infinitesimal $\mmm{I} + \mmm{A}$, por ser matriz de rotación,
debe ser ortogonal
\[
  \mmm{R}^\trasp \mmm{R} = \mmm{I}
\]
...
Para dilucidar cuál es la matriz que está de acuerdo con nuestra definición de
$\varepsilon$, hacemos girar infinitesimalmente los ejes en sentido positivo, por lo
