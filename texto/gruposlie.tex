...
En la figura~\ref{fig:gli-rotated_axes} llevamos a cabo una \emph{rotación pasiva} \footnotemark{}, girando los ejes un ángulo $\alpha$ en sentido positivo.
...
\subsection[Mediante transformación que deja invariante las distancias] {Caracterización por medio de una transformación que deja invariante las distancias}\label{subsec:invariante_distancias}
...
\begin{itemize}
\item La matriz de rotación depende de la dimensión del espacio; cuando éste vale 2, la
  matriz es
