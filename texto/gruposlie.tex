...
\footnotetext{Denotamos los ejes de $\symbb{R}^2$ mediante $x_1$ y $x_2$,   igual que las coordenadas del punto. El lector no debería confudirlos, su interpretación se desprende del contexto.}
...
\begin{figure}[ht]
  ...
  \begin{minipage}{0.40\linewidth}
    ...
    \begin{tikzpicture}[%
      ...
      auxiliar/.style={lightgray, line width=.8pt},
      background/.style={
      ...
      % Ángulo alfa + beta
      \path (xfin) -- (O) -- (P)
      pic [draw=black,fill=black!20,"\footnotesize $\alpha + \beta$",angle radius=6.4mm,
      ...
      \draw[vector] (O) -- (P);
      \draw[auxiliar] (P) -- (P |- xfin);
      \draw[auxiliar] (P) -- (P -| yfin);
...
%        fill=\backgroundcolor, fit= (O) (letraejex) (letraejey)] {};
  ...
  \begin{minipage}{0.45\linewidth}
    ...
    \begin{tikzpicture}[%
      ...
      [draw=black,fill=green!20,"$\alpha$",angle radius=6.4mm,
      angle eccentricity=1.3,-{Latex[length=1.4mm,scale=.9,bend]}]
      {angle = xfin--O--x'fin};
      % Ángulo beta
      \path (x'fin) -- (O) -- (P) pic
      [draw=black!50!,fill=black!20,"$\beta$",angle radius=6.4mm, angle
