...
\begin{figure}[ht]
  ...
  \begin{tikzpicture}[%
    ...
    eje/.style={->},
    posicion/.style={-{Latex}, shorten >=1.2pt, line width=.8pt, draw=\colorVorig},
    textopos/.style={below right=-2.2pt and 0pt,\colorTorig},
    momento/.style={-{Latex}, line width=0.5pt, draw=\colorVorig},
    textomomento/.style={color=\colorTorig, right=-1.5pt},
    posicionrotado/.style={posicion,draw=\colorVrot},
    textoposrotado/.style={above=2pt, \colorTrot},
    momentorotado/.style={momento, \colorVrot},
    textomomrotado/.style={%
      below left=-4pt and -1pt, \colorTrot},
    rcirculo/.style={fill=\colorPorig, draw=black},
    rprimacirculo/.style={\colorProt, draw=black},
    ...
    \path (r) -- (O) -- (r') pic
    [-{Latex[length=3.6pt]},angulogirado,"\footnotesize $\theta$",angle radius=6mm,
    angle eccentricity=1.4] {angle = r--O--r'};
    % ÁNGULO THETA EN VECTORES MOMENTO
    \path (lineagris) -- (r') -- (p') pic
    [-{Latex[length=3.6pt]},draw=black!70!,angulogirado,"\footnotesize $\theta$",angle
    ...
    \draw[line width=0.5pt, black!5,loosely dotted] (r') -- (lineagris);
    % VECTOR r'
