...
\section{El lagrangiano \mathinhead{\symcal{L}}{sdlkfjji9}}
...
Como $\symcal{L}$ es una función, para rotarlo mediante la matriz $\mmm{R}$, aplicamos la
rotación inversa a las coordenadas de la función
\[
  \vvv{\tilde{r}}
  =
