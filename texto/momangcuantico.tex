...
\begin{tikzpicture}[
  scale=\scl,
  tdplot_main_coords,
  vector/.style={-{Latex[round]},\colorVoriguno, line width=1pt},
  vectorampliado/.style={-{Latex[round]},\colorVoriguno, line width=2pt},
  texto/.style={\colorToriguno},
  background/.style={
    line width=\bgborderwidth,
    draw=\bgbordercolor,
    fill=\bgcolor,
...
%  },
  ...
  \draw[vector] (0,0,0) -- (dx);
  \node[above left,texto] at (dx) {\small $\vvv{x}$};
  \draw[vectorampliado] (0,0,0) -- (dy); 
  \node[above,texto] at (dy) {\small $\vvv{y}$};
  \draw[vector]  (0,0,0) -- (dz);
  \node[left,vector] at (dz) {\small $\vvv{z}$};
  ...
  \begin{scope}[xshift=9cm]
    ...
    \draw[thick,->] (0,0,0) -- (0,\longeje,0) node[below right=-5pt and 0pt]{$y$};
    \draw[thick,->] (0,0,0) -- (0,0,\longeje) node[anchor=south]{$z$};
    \draw[vectorampliado] (0,0,0) -- (ddy);
    \node[texto] at (ddy) {$\xtilde{y}$};
