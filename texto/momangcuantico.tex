...
$L^2\!\left(\symbb{R}^3\right)$, esto es, funciones complejas de variable real en el espacio euclídeo.
...
de rotación de funciones.
Usaremos $\Psi(x,y,z)$ para representar cualquier función genérica; el símbolo $\Psi$ lo
utilizamos para que parezca una función de onda de mecánica cuántica, pero por ahora, para
nosotros podrá ser cualquier función, real o compleja, de las coordenadas, aunque en
más tarde, $\Psi(x,y,z)$ representará después cualquier función compleja de variable real.

Queremos rotar una función en sentido antihorario. La matriz de rotación activa es esto es equivalente a girar los ejes
de coordenadas en sentido horario
