...
La igualdad $\tilde{\Psi}\!\left(\tilde{x},\tilde{y}\right) = \Psi(x,y)$,
nos da la pista para obtener la expresión de la función rotada.
Lo que tenemos que hacer es sustituir la coordenadas originales $x$ e $y$ del segundo
miembro de la igualdad anterior por las nuevas $\tilde{x}$ y $\tilde{y}$ con objeto
de obtener $\tilde{\Psi}$ en función de las nuevas coordenadas
$\tilde{\Psi}\!\left(\tilde{x},\tilde{y}\right)$ y no de las originales.
