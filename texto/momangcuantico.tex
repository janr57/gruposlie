...
\begin{figure}[ht]
  \def\scl{1}
  % Color de vector original
  \newcommand{\colororig}{black!30}
  % \newcommand{\colororig}{green!70!black}
  % Color texto vector original
  \newcommand{\colortxtorig}{black!60}
  %\newcommand{\colortxtorig}{green!60!black}  
  % Color punto original
  %\newcommand{\colorptoorig}{green}
  \newcommand{\colorptoorig}{gray}
  % Color de vector rotado
  \newcommand{\colorrot}{red!90!black}
  % Color texto vector rotado
  \newcommand{\colortxtrot}{red!60!black}
  % Color punto rotado
  \newcommand{\colorptorot}{red}
  %
  ...
  \begin{tikzpicture}[%
    ...
    vectorR/.style={-{Latex[width=6pt,length=6pt]},\colororig,line width=1.2pt},
    vectorRt/.style={-{Latex[width=6pt,length=6pt]},\colorrot,line width=1.2pt},
    puntoP/.style={fill=black,draw=black,radius=0.8pt},
    puntoPt/.style={fill=black,draw=black,radius=0.8pt},
    puntoR/.style={fill=\colorptoorig,draw=black,radius=1.4pt},
    puntoRt/.style={fill=\colorptorot,draw=black,radius=1.4pt},
    textoP/.style={color=\colortxtorig},
    textoPt/.style={color=\colortxtrot},
    textoR/.style={textoP},
...
en su lugar se colorean en rojo las variables de la función como si fueran vectores
cuya resultante nos dé un punto de la función abstracta definida en $\symbb{R}^3$.
...
Como no sabemos calcular la derivada parcial con respecto de $y$ ---el vector en rojo que
...
\begin{tikzpicture}[
  ...
  \node[above left,red!80!black] at (dx) {$\vvv{x}$};
  \draw[line width=2pt, -{Latex[round]}, red!80!black] (0,0,0) -- (dy); 
  \node[above,red!80!black] at (dy) {$\vvv{y}$};
  \draw[line width=1pt, -{Latex[round]}, red!80!black] (0,0,0) -- (dz);
  \node[left,red!80!black] at (dz) {$\vvv{z}$};
  ...
  \end{scope}
    ...
    \node[right=4pt,red!80!black] at (ddy) {$\xtilde{y}$};
    \draw[line width=1pt, -{Latex[round]}, red!80!black] (0,0,0) -- (ddx);
    \node[above,red!80!black] at (ddx) {$\xtilde{x}$}; 
