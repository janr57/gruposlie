...
\[
  ...
  =
  \exp\left\{
    \theta\vvv{r}^\dagger (\xhat{n}\cdot\mmm{J})\,(-i)\hbar\vvv{\nabla}
  \right\}
  \,\Psi(\vvv{r})  
  =
  \exp\left\{
    \theta\vvv{r}^\dagger (\xhat{n}\cdot\mmm{J})\,\dfrac{\vvv{p}}{\hbar}
  \right\}
  \,\Psi(\vvv{r})  
\]
\[
  \tilde{\Psi}(\xtilde{r})
  = \exp\left\{
    \frac{\theta}{\hbar}\vvv{r}^\dagger (\xhat{n}\cdot\mmm{J})\vvv{p}
  \right\}
  \,\Psi(\vvv{r})
\]
...
\begin{equation}
  ...
  \mmm{R}(\xhat{n},\theta)
  =
  \exp\left\{\frac{\theta}{\hbar}\, \xhat{n}\cdot\vvv{L}\right\}
\end{equation}
