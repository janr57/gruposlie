...
\begin{figure}[ht]
  ...
  \begin{tikzpicture}[%
    ...
    % PRUEBA
%    \filldraw[fill=black,draw=black] (rp) circle[radius=1.2pt];
%    \filldraw[fill=black,draw=black] (Pty) circle[radius=1.2pt];
%    \filldraw[fill=black,draw=black] (Pvalor) circle[radius=1.2pt];
%    \filldraw[fill=black,draw=black] (Rtvalor) circle[radius=1.2pt];
%    \filldraw[fill=black,draw=black] (z) circle[radius=1.2pt];
    ...
    %\node[above left=0pt and -4pt, green!60!black] at (Rmedio) {\footnotesize $\vvv{r}$};
    \node[below right=-4pt and -1pt, green!60!black] at (Rmedio)
    {\footnotesize $\vvv{r}$};
    \draw[dominioRt, use path=\pathRt];
    \node[below left=-2pt and 2pt,red!60!black] at (Rtmedio)
    ...
    % \draw[vectorP] (0,0,0) -- coordinate (Pmedio) (Rvalor);
...
%    \node[right=0pt, green!60!black] at (Rmedio) {\footnotesize$\vvv{P}$};
    
%    Vector de posición del punto Ptilde en rojo
    \draw[vectorPt, use path=\pathPt];
    %\draw[vectorP] (0,0,0) -- coordinate (Ptmedio) (Rtvalor);
...
%    \filldraw (rp) circle[radius=0.8pt];
