...
\begin{figure}[ht]
  ...
  \begin{tikzpicture}[%
    ...
    puntoP/.style={fill=green,draw=black, radius=1.2pt},
    puntoPt/.style={fill=red,draw=black, radius=1.2pt},
    textoRP/.style={green!60!black},
    textoRtPt/.style={red!60!black},
    lineaguia/.style={black!50, line width=0.8pt, densely dotted},
    background/.style={%
      line width=\bgborderwidth,
      draw=\bgbordercolor,
    ...
    % COORDENADAS
    \path[save path=\pathP] (0,0,0) -- coordinate (Pmedio) (\PVEC,0,0) coordinate (P);
    \path[save path=\pathPt](0,0,0) -- coordinate (Ptmedio) (0,\PtVEC,0) coordinate (Pt);
    ...
    \node[left=2pt, textoRP] at (P) {\footnotesize $\vvv{P}(1,0)$};
    % PUNTO DOMINIO Ptilde
    \filldraw[puntoPt] (Pt) circle;
    \node[above right=-2pt and -1pt, textoRtPt] at (Pt)
    {\footnotesize $\vvv{\tilde{P}}(0,1)$};
    ...
    \node[left=2pt, textoRP] at (R) {\footnotesize $(1,0,2)$};
    
    % VECTOR DE POSICIÓN rtilde
    \draw[vectorRt, use path=\pathRt];
    \node[right=1pt, textoRtPt] at (Rt) {\footnotesize $(0,1,2)$};    
