...
Para girar un vector un ángulo $\theta$, alrededor del eje $z$, deberíamos utilizar la
...
punto del espacio $x, y, z$ un valor que puede ser complejo.


\subsection{Rotación de una función}
...
función lo hubiera hecho en sentido contrario. Así, podríamos suponer que los ejes no
han girado y la función lo ha hecho en sentido contrario (horario).
...
Hemos utilizado el generador de rotación de vectores, pero ahora nos interesamos por el
generador de rotación de funciones.
Se usará el símbolo $\Psi(x,y,z)$ para representar cualquier función genérica; el símbolo
$\Psi$ lo utilizamos para que parezca una función de onda de física cuántica, pero por
ahora para nosotros será podrá ser cualquier función de las coordenadas, aunque en
realidad $\Psi(x,y,z)$ representará después cualquier función compleja de variable real.
