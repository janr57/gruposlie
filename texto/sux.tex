...
unitaria, sino en el valor del determinante \eqref{eq:sux-determinante_U}, que imponemos
...
componentes de un vector unitario $\xhat{n}$, con las debidas reservas, dado que
$\xhat{\vvv{n}}\cdot\mmm{\sigma}$ no es un producto escalar, aunque aquí utilizamos
esta simbología para abreviar la expresión matemática (mejor sería utilizar la notación
de Einstein ("$\xhat{\vvv{n}}\cdot\mmm{\sigma}$"\hspace{-1.5pt} $= n_i\sigma_i$)
\[
  \mmm{B}_{2\times 2}
  =
